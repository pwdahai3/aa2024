<template>
  <div>
    <el-dialog width="40%" :title="$t('lg.addmacconfig')" :visible.sync="isMacShow" :close-on-click-modal="false" :before-close="resetForm">
    ...
    addUser(formname){
      this.$refs[formname].validate((valid)=>{
        if(valid){
          ...
          var url=SERVER_API_URL+"pe/shadow/firewallmac/add";
